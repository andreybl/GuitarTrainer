...
//        {
//            Key key = Key.keyByScaleAndMode(Key.D, Degree.THREE);
//            assertEquals(Key.Fdi, key);
//        }
//        {
//            Key key = Key.keyByScaleAndMode(Key.A, Degree.FIVE);
//            assertEquals(Key.E, key);
//        }
//
//        {
//            Key key = Key.keyByScaleAndMode(Key.G, Degree.THREE);
//            assertEquals(Key.B, key);
//        }
//
//        {
//            Key key = Key.keyByScaleAndMode(Key.B, Degree.SEVEN);
//            assertEquals(Key.Adi, key);
//        }
//
//        for (Key k : Key.values()) {
//            for (Degree d : Degree.STRONG_DEGREES) {
//                Key key = Key.keyByScaleAndMode(k, d);
...
//    }
    ...
    public void test_Keys_KeyDegree2ParentScale() {
        {
            Key key = Key.parentScaleByKeyAndMode(Key.C, Degree.ONE);
            assertEquals(Key.C, key);
        }

        {
            Key key = Key.parentScaleByKeyAndMode(Key.C, Degree.FIVE);
            assertEquals(Key.F, key);
        }

        {
            Key key = Key.parentScaleByKeyAndMode(Key.C, Degree.SEVEN);
            assertEquals(Key.Cdi, key);
        }

        {
            Key key = Key.parentScaleByKeyAndMode(Key.A, Degree.TWO);
