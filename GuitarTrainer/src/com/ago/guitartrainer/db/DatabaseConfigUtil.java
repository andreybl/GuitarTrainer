...
public class DatabaseConfigUtil extends OrmLiteConfigUtil {
    public static final Class<?>[] classes = new Class[] { QuestionScalegridDegree2Position.class, QuestionMetrics.class, QuestionPosition2Note.class, QuestionNote2Position.class};
