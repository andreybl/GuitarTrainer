...
public class FragmentModeDegree2Parent extends Fragment {
    ...
    private LessonModeDegree2Parent lesson;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        LinearLayout mainLayout = (LinearLayout) inflater
                .inflate(R.layout.fragment_modedegree2parent, container, false);
    ...
    public void onInitializationCompletedListener(LessonModeDegree2Parent lesson) {
        this.lesson = lesson;
    }
